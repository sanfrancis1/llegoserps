 ...
 <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($page=='dashboard') { echo 'active'; }?>" style="display: <?php if($name != 'Administrator') { echo 'none'; }?>;">
        ...
        <li class="<?php if($page=='apartment') { echo 'active'; }?>" style="display: <?php if($name != 'Administrator') { echo 'none'; }?>;">
        ...
        <li class="<?php if($page=='checkout_visitors') { echo 'active'; }?>">
         ...
         <li class="<?php if($page=='vehicle') { echo 'active'; }?>">
          <a href="vehicle-entry.php">
            <i class="fa fa-plus"></i> <span>Vehicle Registry</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"><?php include './counters/todays-visitor-count.php'?></small>
            </span>
          </a>
        ...
        <li class="<?php if($page=='checkout_vehicle') { echo 'active'; }?>">
          <a href="checkout_vehicle.php">
            <i class="fa fa-sign-out"></i> <span>Check-Out Vehicle</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green"><?php include './counters/checkout-visitor.php'?></small>
            </span>
          </a>
