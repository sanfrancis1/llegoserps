...
echo("<script type='text/javascript'> console.log('Test');</script>");
    ...
    $query=mysqli_query($con,"UPDATE departments set department='$newreason' where  ID='$eid'");
 
    if ($query){
        $msg="Reason Details has been updated";
    } else {
  ...
  <div class="content-wrapper">
    ...
    <!-- <small>Control panel</small> -->
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Reason</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          ...
          <?php
            $eid=$_GET['editid'];
            $ret=mysqli_query($con,"SELECT * from  Reasons where ID='$eid'");
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Reason</label>
                    <input type="text" class="form-control" value="<?php  echo $row['reason'];?>" disabled >
                  </div>
				  </div>           
            <div class="col-md-6">
         			   <div class="form-group">
          		   <label>New Reason</label>
           			 <input type="text" class="form-control" name = 'newreason'>    
                  </div>
             </div>
                <!-- /.col -->
              </div>
