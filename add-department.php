<?php
  ...
  if (strlen($_SESSION['avmsaid']==0)) {
    ...
    $query=mysqli_query($con,"INSERT into departments(department) value ('$department')");

      if ($query) {
      $msg="Department Person Details Added!";
    } else {
                ...
                <form method="POST" class="">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="department" required>
     				 ...
     				 <div class="form-group">
                    <label></label>
                     <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Insert Department Details</button>
                  </div>
