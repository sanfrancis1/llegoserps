...
echo("<script type='text/javascript'> console.log('Test');</script>");
    ...
    $query=mysqli_query($con,"UPDATE departments set department='$newdeptname' where  ID='$eid'");
    ...
    <section class="content">
      ...
      <?php if($msg){ echo "<div class='alert alert-success alert-dismissible'>
        ...
        <div class="box box-default">
          ...
          <?php
            $eid=$_GET['editid'];
            $ret=mysqli_query($con,"SELECT * from  departments where ID='$eid'");
            ...
            <div class="col-md-6">
          		   ...
          		   <label>New Department Name</label>
           			 <input type="text" class="form-control" name = 'newdeptname'>    
                  </div>
             </div>
                <!-- /.col -->
              </div>
