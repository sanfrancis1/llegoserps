<?php
  ...
  if (strlen($_SESSION['avmsaid']==0)) {
    ...
    $query=mysqli_query($con,"INSERT into Reasons(reason) value ('$reason')");

      if ($query) {
      $msg="Reason Details Added!";
    } else {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Manage Reasons</li>
      </ol>
    </section>
                ...
                <form method="POST" class="">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="reason" required>
     				 ...
     				 <div class="form-group">
                    <label></label>
                     <button type="submit" class="btn btn-block btn-primary btn-lg" name="submit">Insert Reason Details</button>
                  </div>
